...
/// Compile-safe shell replaced by the Media3 implementation milestone.
final class UnsupportedAndroidPlayer implements YlPlatformPlayer {
  ...
  static const YlPlayerError _unsupportedError = YlPlayerError(
    ...
    code: 'android.not_implemented',
    message: 'The Android Media3 backend has not been implemented yet.',
  );
  ...
  Future<void> _fail() {
    if (_disposed) {
      return Future<void>.error(
        StateError('The Android platform player has been disposed.'),
      );
    }
