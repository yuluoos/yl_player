...
final class ChannelAndroidPlayer implements YlPlatformPlayer {
  ChannelAndroidPlayer({
  ...
  YlPlayerState _state = YlPlayerState(engine: YlPlaybackEngine.media3);
  ...
  Future<void> _command(
    ...
    if (_disposed) {
      throw StateError('The Android platform player has been disposed.');
    }
    try {
      ...
      final playerError = decodePlatformException(error, platform: 'android');
