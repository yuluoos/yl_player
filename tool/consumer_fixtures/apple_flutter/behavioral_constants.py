...
def main():
    from historical_migration import verify_historical
    failures = verify_historical()
    if failures:
        print(json.dumps(failures, indent=2))
        return 1
    print('Verified HISTORICAL Apple migration parity at 65cdfd5: 57 comparisons, 98 frozen source inputs; current playback semantics are tested separately.')
    return 0
