...
| Native iOS XCTest | Pass | Routing, demux metadata, AAC/MP3 setup, reconnect controller/lifecycle, HLS rewriting, origin policy, proxy handoff, cancellation, and rollback are covered. |
